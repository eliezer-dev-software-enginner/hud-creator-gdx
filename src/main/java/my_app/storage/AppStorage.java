...
/**
 * Persists the scene2d-buider application's own preferences — as opposed to
 * a UI layout, see {@link my_app.project.UiLayout} for that — across runs:
 * the grid toggle and which layout JSON to auto-reopen on the next launch.
 * Lives in a small JSON file under the user's home directory by default,
 * independent of whatever directory the app happens to be launched from.
 * <p>
...
public final class AppStorage {
    ...
    public static final Path DEFAULT_FILE = Path.of(System.getProperty("user.home"), ".scene2d-buider", "settings.json");
