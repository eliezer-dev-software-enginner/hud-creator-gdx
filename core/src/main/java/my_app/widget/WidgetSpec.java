...
/**
 * What to place on the canvas — either a raw atlas region (a decorative
 * image) or a widget resolved from a named style in the loaded skin.
 * {@link my_app.editor.WidgetFactory} turns one of these into a real
 * Scene2D actor; {@link PlacedWidget} pairs one with a canvas position once
 * it's been dropped.
 */
